...
const url = "https://www.youtube.com/watch?v=l9ViEIip9q4";
                    ...
                    children: <Widget>[
                      ...
                      Positioned(
                        child: FadeAnimation(1.6, Container(
                          ...
                          child: Center(
                            child: Text("NDTV News Live", style: TextStyle(color: Colors.white, fontSize: 40, fontWeight: FontWeight.bold),),
                          ),
                        )),
                      )
                    ],
